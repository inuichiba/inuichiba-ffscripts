...
console.log("🔐 accountId (先頭5):", accountId?.substring(0, 5), "長さ:", accountId?.length);
const aId = "39914da7b7f259b59d901f0b57cc17cc";
console.log("🔐 正しいaId:(先頭5):", aId?.substring(0, 5), "長さ:", aId?.length);

  console.log("🔐 FFDEV  Tokenの先頭:", process.env.KV_API_TOKEN_FFDEV?.substring(0, 5), "長さ:", process.env.KV_API_TOKEN_FFDEV?.length);
  console.log("🔐 FFPROD Tokenの先頭:", process.env.KV_API_TOKEN_FFPROD?.substring(0, 5), "長さ:", process.env.KV_API_TOKEN_FFPROD?.length);

  console.log("🔐 namespaceId の先頭:", namespaceId?.substring(0, 5), "長さ:", namespaceId?.length);
